...
<head>
    <meta charset="UTF-8">
    <link rel="stylesheet" href="../css/change_availability_sharing_point_settings_page.css">
    <link href="https://fonts.googleapis.com/css2?family=Pacifico&display=swap" rel="stylesheet">
    <link href="https://fonts.googleapis.com/css2?family=Righteous&display=swap" rel="stylesheet">
    <script src="https://code.jquery.com/jquery-3.5.1.js" integrity="sha256-QWo7LDvxbWT2tbbQ97B53yJnYU3WhH/C8ycbRAkjPDc=" crossorigin="anonymous"></script>
    <title>Sharing point settings</title>
</head>
<body>
        ...
        <div class="body__information">
            <table border="1" cellspacing="0" color="dimgrey">
                <tr>
                    ...
                    <td>Close sharing point</td>
                    <td>Open sharing point</td>
                </tr>
                <c:forEach var="pointInfo" items="${sharePointInformationList}">
                    <tr>
                        ...
                        <td class="openclose${pointInfo.sharePointSequenceNumber}">${pointInfo.sharePointSequenceNumber}</td>
                        <td>${pointInfo.umbrellaCol}</td>
                        <td><a class="close" id="close${pointInfo.sharePointSequenceNumber}"></a></td>
                        <td><a class="open" id="open${pointInfo.sharePointSequenceNumber}"></a></td>
                    </tr>
                </c:forEach>
            </table>
        </div>
...
<script type="text/javascript" src="../js/CloseOpenSharingPoint.js"></script>
</html>
